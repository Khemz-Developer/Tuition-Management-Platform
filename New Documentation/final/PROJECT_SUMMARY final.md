...
│   │   │       ├── LessonEditor.tsx
│   │   │       └── MaterialUpload.tsx
│   │   │   └── website-builder/   # Public website builder components
│   │   │       ├── ThemeCustomizer.tsx
│   │   │       ├── SectionList.tsx
│   │   │       ├── SectionEditor.tsx
│   │   │       ├── ContentEditor.tsx
...
│   │   │   │   ├── ChatWindow.tsx
│   │   │   │   └── MessageList.tsx
│   │   │   └── public-website/    # Public teacher website components
...
│   │   │   │   └── index.tsx      # Browse/search all teachers
│   │   │   └── Public/            # Public teacher profile pages
│   │   │       └── [slug].tsx     # Dynamic page at /t/:teacherSlug
│   │   │
│   │   ├── layouts/               # Layout components
│   │   │   ├── StudentLayout.tsx
│   │   │   ├── AuthLayout.tsx
...
│   │   ├── website.types.ts       # Public website config types
│   │   └── api.types.ts
│   │
...
│   │   ├── message.schema.ts
│   │   └── website.schema.ts      # Website config validation
│   │
...
│       ├── helpers.ts
│       └── themes/
│           └── applyTheme.ts      # Theme application utility
│
├── package.json
├── tsconfig.json
└── README.md
...
# Part 3: User Experience & Features
...
**Architecture Approach**: Component-based rendering with database-driven configuration for maximum flexibility. The public teacher website is integrated into the existing single frontend application.

**Location**: The components are split between two folders based on their purpose:

#### 1. Public Viewing Pages (in `student-web/`)

Students and public visitors view these pages:
...
│   │   └── index.tsx                  # Browse/search all teachers
│   └── Public/
│       └── TeacherProfile/            # Public teacher profile pages
│           └── [slug].tsx             # Dynamic page at /t/:teacherSlug
│
├── components/
│   └── public-website/                # Public teacher website components
...
│       │
│       ├── layout/
│       │   ├── PublicPageLayout.tsx   # Main layout wrapper
│       │   └── SectionContainer.tsx
│       │
│       ├── widgets/
│       │   └── AIChatWidget.tsx       # AI assistant chat widget
│       │
│       └── renderer/
...
#### 2. Website Management (in `admin-teacher-web/`)

Teachers customize their public website from their dashboard:
...
│   └── teacher/
│       └── Profile/
│           └── Website/               # Website customization dashboard
│               ├── index.tsx          # Main customization page
│               ├── Theme.tsx          # Theme customization tab
│               ├── Sections.tsx       # Section builder (drag & drop)
│               ├── Content.tsx        # Content editor tab
│               └── Preview.tsx        # Live preview tab
...
│       ├── ThemeCustomizer.tsx        # Color, font pickers
│       ├── SectionList.tsx            # Drag & drop section list
│       ├── SectionEditor.tsx          # Edit individual section
│       ├── ContentEditor.tsx          # Rich text editor for content
│       ├── SEOSettings.tsx            # Meta title, description
│       └── PreviewFrame.tsx           # Live preview iframe
```

#### 3. Shared Types & Utils (in `shared/`)
...
# Part 4: Implementation & Development
...
# Part 6: Reference & Getting Started
